...
import util.generic as utl #importa de la caprpeta de utilidades
...
class App:
    def verificar(self):
        ...
        if usuario == "salle" and contrasena == "12345":   
            ...
            messagebox.showerror(message= "la cotrasena no es correcta", title= "Error")
    ...
    def __init__(self):        
        ...
        logo = utl.leer_imagen("Login/Imagenes/logo.png", (200, 200))
